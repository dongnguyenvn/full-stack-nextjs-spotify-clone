/*
  ...
  - You are about to drop the column `updatedAte` on the `Artist` table. All the data in the column will be lost.
  - You are about to drop the column `updatedAte` on the `Playlist` table. All the data in the column will be lost.
  - You are about to drop the column `updatedAte` on the `Song` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Artist" DROP COLUMN "updatedAte",
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;

-- AlterTable
ALTER TABLE "Playlist" DROP COLUMN "updatedAte",
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL,
ALTER COLUMN "userId" SET NOT NULL;

-- AlterTable
ALTER TABLE "Song" DROP COLUMN "updatedAte",
